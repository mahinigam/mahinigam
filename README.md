...
<h3>Focus Areas</h3>
<ul>
  <li>Data Analytics, Machine Learning, and AI systems</li>
  <li>Problem-solving, algorithms, and backend logic</li>
  <li>Product thinking and clean system design</li>
</ul>

<h3>Currently</h3>
<ul>
  <li>B.Tech in Computer Science (Class of 2027)</li>
  <li>Exploring real-world applications of data and intelligent systems</li>
  <li>Building projects to understand systems end-to-end</li>
</ul>
